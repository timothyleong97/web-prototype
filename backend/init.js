...
query(`INSERT INTO restaurants(rid,min_order_amt,located_at,restaurant_name)
VALUES(51,31,1,'The Mellow Well');`)
query(`INSERT INTO restaurants(rid,min_order_amt,located_at,restaurant_name)
VALUES(52,24,2,'The Japanese Window');`)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Water, Tap'",9.4,'Grocery',22,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Table Cloth 120 Round White',5.5,'Grocery',13,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Soup - Cream Of Broccoli',5.8,'Grocery',43,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Juice - Tomato, 48 Oz'",1.8,'Grocery',35,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Tea - Apple Green Tea',3.4,'Grocery',39,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Wine - Niagara,vqa Reisling'",2.1,'Grocery',18,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Tia Maria',4.4,'Grocery',26,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Juice - Clam, 46 Oz'",4.6,'Grocery',25,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Thermometer Digital',7.8,'Grocery',10,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Oregano - Dry, Rubbed'",6.1,'Grocery',39,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Bread - Dark Rye, Loaf'",4.6,'Grocery',24,0,3);`)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Liquid Aminios Acid - Braggs',9.8,'Grocery',46,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Muffin Chocolate Individual Wrap',5.1,'Grocery',19,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Potatoes - Peeled',4.8,'Grocery',22,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Pepper - Yellow Bell',5.1,'Grocery',12,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Cherries - Maraschino,jar'",4.4,'Grocery',45,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Lamb - Whole, Fresh'",4.1,'Grocery',49,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Ecolab Crystal Fusion',2.9,'Grocery',41,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Chicken Giblets',6.9,'Grocery',25,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Oil - Food, Lacquer Spray'",1.5,'Grocery',44,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Yucca',8.8,'Grocery',47,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES("'Trout - Rainbow, Frozen'",8.2,'Grocery',46,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Pail With Metal Handle 16l White',4.1,'Grocery',42,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
