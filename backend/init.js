...
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Ee Fu Mee',2,'Chinese',50,0,1);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Fried Rice',4,'Chinese',50,0,1);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Shark fin',30,'Chinese',50,0,1);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Bird nest',25,'Chinese',50,0,1)`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Cold cut trio',15.50,'Lifestyle',10,0,2);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Tuna',25.50,'Lifestyle',10,0,2);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Turkey',12.50,'Lifestyle',10,0,2);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Subway club',13.50,'Lifestyle',10,0,2);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Big Mac',5.50,'Western',100,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Mc chicken',5.50,'Western',100,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Mc spicy',5.50,'Western',100,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Samurai burger',5.50,'Western',100,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Mcnuggets',5.50,'Western',100,0,3);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Healthy stuff',10.50,'Lifestyle',50,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Vegan meatball',12.50,'Lifestyle',50,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Fruit shake',5.50,'Lifestyle',50,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Salad bowl',6.50,'Lifestyle',50,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Brown rice',10.50,'Lifestyle',50,0,4);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Chicken Rice',4.50,'Chinese',50,0,7);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Duck Rice',5.00,'Chinese',50,0,7);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Roasted Pork',5.50,'Chinese',50,0,7);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('tao hau',1.50,'Chinese',50,0,7);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Egg',0.50,'Chinese',50,0,7);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Fish and Chip',5.50,'Western',100,0,9);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Pork chop',5.50,'Western',100,0,9);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('steak',5.50,'Western',100,0,9);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Chicken chop',5.50,'Western',100,0,9);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('char grill',5.50,'Western',100,0,9);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Tomato',10.50,'Soup',100,0,8);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Mushroom',12.50,'Soup',100,0,8);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Beef strew',15.50,'Soup',100,0,8);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('corn',17.50,'Soup',100,0,8);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('carrot',15.50,'Soup',100,0,8);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('ABC',5.50,'Soup',100,0,6);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Salted vegetable',15.50,'Soup',100,0,6);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Pork ribs',15.50,'Soup',100,0,6);`)
query(`INSERT INTO food_items(food_item_name,price,category,daily_limit,num_orders_made,rid)
VALUES('Cure illness',15.50,'Soup',100,0,6);`)
